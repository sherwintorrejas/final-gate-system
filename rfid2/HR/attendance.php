...
if ($dateSelected) {
    ...
    // If no date or name is selected, default to today's date
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                ...
                                <form method="POST" action="exportattendance.php" style="display: inline;">
    <input type="hidden" name="date" value="<?php echo $dateSelected; ?>">
    <input type="hidden" name="name" value="<?php echo $nameSearch; ?>">
    <button id="exportBtn" type="submit" class="btn btn-primary" style="float: right; margin-top: 20px; margin-right: 100px">Export</button>
</form>
