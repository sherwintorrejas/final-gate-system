...
$query = "
    SELECT registudent.sid, registudent.did, registudent.cid, registudent.guardiannumber, registudent.image, 
           information.name AS student_name, information.schoolid AS student_id, 
           information.department AS course, rfid.uid AS rfid
    FROM registudent
    ...
    WHERE blockrfd.sid IS NULL
      AND information.department NOT IN (
...
";
 // Only show students not in blockrfd
