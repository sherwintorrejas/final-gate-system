    ...
    if ($result->num_rows > 0) {
        ...
        if ($passwordResult->num_rows > 0) {
            ...
            if (password_verify($password, $passwordRow['password'])) {
                ...
                switch ($category) {
                  case 'ADMIN':
                    header("Location: rfid2/Admin/index.php");
                    break;
                    case 'HR':
                    ...
                    case 'REGISTRAR':
                        ...
                        break;
                    case 'BEED REGISTRAR':
                        header("Location: rfid2/beedregis/index.php");
                        break;
                    default:
...
<body>
  <div class="wrapper">
    <form action="" method="POST">
      ...
      <div class="register">
        <p><a href="idpic/display/TIMEIN.php"> Time In</a></p>
        <p><a href="idpic/display/TIMEOUT.php"> Time Out</a></p>
